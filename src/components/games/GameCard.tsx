...
export function GameCard({ game, priority = false, onPreview }: { game: GameItem; priority?: boolean; onPreview?: (game: GameItem) => void }) {
      ...
      <span className="relative block aspect-[4/3] overflow-hidden bg-[#111720]">
        ...
        {onPreview && (
          <button
            ...
            className="absolute right-2 top-2 z-10 flex items-center gap-1 rounded-lg border border-amber-400/30 bg-black/60 px-2 py-1 text-[9px] font-bold text-amber-300 opacity-90 backdrop-blur-md transition hover:bg-black/90 hover:scale-105 group-hover:opacity-100"
